# Edge15 AI Oracle v2.1 — Round Scout Grading
...
- Adds **Early Scout History** with round-level scout summaries so repeated snapshots do not inflate the early-entry record.
- Splits faded signals into more useful categories such as confirmed win/loss, faded but won, faded and lost, flipped, or faded to skip when data is available.
- Adds a clear **Early Entry** label: Early Entry Possible, Wait for Lock, Watch Only, or Do Not Enter Early.
...
app.js              Scanner, AI council, official lock engine, likely-lock forecast, round scout grading
